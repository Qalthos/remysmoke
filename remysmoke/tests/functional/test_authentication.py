...
As remysmoke grows and the authentication method changes, only these tests
should be updated.

"""

from remysmoke.tests import TestController
...
class TestAuthentication(TestController):
    ...
    def test_forced_login(self):
        ...
        resp = self.app.get('/smoke/', status=302)
        ...
        assert initial_page.location.startswith('http://localhost/smoke/'), \
